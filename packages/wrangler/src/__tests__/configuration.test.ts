	...
	describe("top-level environment configuration", () => {
		...
		`);
			...
			"Processing wrangler configuration:
			  ...
			  - \\"constellation[0]\\" bindings must have a \\"project\\" field but got {}.
			  - \\"constellation[1]\\" bindings must have a \\"project\\" field but got {\\"binding\\":\\"VALID\\"}.
			  - \\"constellation[2]\\" bindings should have a string \\"binding\\" field but got {\\"binding\\":2000,\\"project\\":2111}.
			  - \\"constellation[2]\\" bindings must have a \\"project\\" field but got {\\"binding\\":2000,\\"project\\":2111}."
		`);
			});
		});
